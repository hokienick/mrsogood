    ...
    <>
      <section className="bg-ink pt-32 pb-16 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <h1 className="display text-fluid-xl text-chalk mb-6">The Work.</h1>
          <p className="font-body text-chalk/70 text-lg max-w-md">
      ...
      <section className="bg-coral py-20 px-6 md:px-10">
        <div className="max-w-3xl mx-auto">
          <h2 className="display text-fluid-lg text-chalk mb-6">Want to be next?</h2>
          <p className="font-body text-chalk/70 text-lg mb-8">Free mockup. 24 hours. No obligation.</p>
          <Link href="/#contact"
